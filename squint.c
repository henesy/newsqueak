...
#line	2	"/usr/seh/repos/newsqueak/squint.y"
#include "store.h"
#include "node.h"
#include "symbol.h"
//#include <u.h>
...
#line	17	"/usr/seh/repos/newsqueak/squint.y"
typedef union {
	Node	*n;
	Symbol	*s;
	Store	*st;
...
case 1:
#line	55	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 3:
#line	62	"/usr/seh/repos/newsqueak/squint.y"
{
...
case 4:
#line	99	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-0].yyv.n;
		goto Compile;
	} break;
case 6:
#line	107	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NList, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 8:
#line	114	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NList, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 10:
#line	121	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NDeclsc, yypt[-0].yyv.n, Z, yypt[-1].yyv.i);
	} break;
case 11:
#line	125	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, yypt[-0].yyv.n, Z, TType);
		yyval.n=new(NDecl, yypt[-2].yyv.n, yyval.n, Z);
	} break;
case 12:
#line	130	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NRec, yypt[-0].yyv.n, Z, Z);
	} break;
case 13:
#line	136	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NRec, yypt[-1].yyv.n, Z, Z);
	} break;
case 16:
#line	144	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NList, yypt[-2].yyv.n, yypt[-1].yyv.n, Z);
	} break;
case 17:
#line	148	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NList, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 18:
#line	154	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NDecl, yypt[-2].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 19:
#line	158	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NDecl, yypt[-3].yyv.n, Z, yypt[-0].yyv.n);
	} break;
case 20:
#line	162	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NDecl, yypt[-4].yyv.n, yypt[-2].yyv.n, yypt[-0].yyv.n);
	} break;
case 21:
#line	166	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NDecl, yypt[-6].yyv.n, yypt[-4].yyv.n, new(NMk, dupnode(yypt[-4].yyv.n), Z, Z));
	} break;
case 23:
#line	173	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.i=yypt[-1].yyv.i|yypt[-0].yyv.i;
	} break;
case 24:
#line	179	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.i=SCconst;
	} break;
case 25:
#line	183	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.i=SCbltin;
	} break;
case 26:
#line	188	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=idnode(yypt[-0].yyv.s);
	} break;
case 27:
#line	192	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=idnode(yypt[-0].yyv.s);
		yyval.n=new(NList, yypt[-2].yyv.n, yyval.n, Z);
	} break;
case 29:
#line	200	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, yypt[-2].yyv.n, yypt[-0].yyv.n, TArray);
	} break;
case 30:
#line	204	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, Z, yypt[-0].yyv.n, TChan);
	} break;
case 31:
#line	208	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, yypt[-1].yyv.n, Z, TStruct);
	} break;
case 32:
#line	212	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, yypt[-2].yyv.n, yypt[-0].yyv.n, TProg);
	} break;
case 33:
#line	218	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, Z, Z, TUnit);
	} break;
case 34:
#line	222	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, Z, Z, TInt);
	} break;
case 35:
#line	226	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, Z, Z, TChar);
	} break;
case 36:
#line	230	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=idnode(yypt[-0].yyv.s);
		yyval.n=newi(NType, yyval.n, Z, TID);
	} break;
case 37:
#line	236	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 38:
#line	240	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-1].yyv.n;
	} break;
case 39:
#line	245	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 41:
#line	252	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=elemrewr(yypt[-2].yyv.n, yypt[-0].yyv.n, Z, NFormal);
	} break;
case 42:
#line	256	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=elemrewr(yypt[-2].yyv.n, yypt[-0].yyv.n, yypt[-4].yyv.n, NFormal);
	} break;
case 43:
#line	262	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=elemrewr(yypt[-3].yyv.n, yypt[-1].yyv.n, Z, NElem);
	} break;
case 44:
#line	266	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=elemrewr(yypt[-3].yyv.n, yypt[-1].yyv.n, yypt[-4].yyv.n, NElem);
	} break;
case 45:
#line	272	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newl(NNum, Z, Z, yypt[-0].yyv.l);
	} break;
case 46:
#line	276	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newst(NString, Z, Z, yypt[-0].yyv.st);
	} break;
case 47:
#line	280	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NUnit, Z, Z, Z);
	} break;
case 48:
#line	284	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-1].yyv.n, Z, PRINT);
	} break;
case 50:
#line	289	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '+');
	} break;
case 51:
#line	293	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '-');
	} break;
case 52:
#line	297	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '*');
	} break;
case 53:
#line	301	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '/');
	} break;
case 54:
#line	305	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '%');
	} break;
case 55:
#line	309	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '&');
	} break;
case 56:
#line	313	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '|');
	} break;
case 57:
#line	317	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '^');
	} break;
case 58:
#line	321	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, ANDAND);
	} break;
case 59:
#line	325	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, OROR);
	} break;
case 60:
#line	329	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, CAT);
	} break;
case 61:
#line	333	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, DEL);
	} break;
case 62:
#line	337	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, EQ);
	} break;
case 63:
#line	341	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, NE);
	} break;
case 64:
#line	345	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '<');
	} break;
case 65:
#line	349	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '>');
	} break;
case 66:
#line	353	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, LE);
	} break;
case 67:
#line	357	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, GE);
	} break;
case 68:
#line	361	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, LSH);
	} break;
case 69:
#line	365	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, RSH);
	} break;
case 70:
#line	369	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, RCV);
	} break;
case 71:
#line	373	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, LEN);
	} break;
case 72:
#line	377	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, REF);
	} break;
case 73:
#line	381	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, DEF);
	} break;
case 74:
#line	385	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, DEC);
	} break;
case 75:
#line	389	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-1].yyv.n, Z, INC);
	} break;
case 76:
#line	393	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, UMINUS);
	} break;
case 77:
#line	397	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, '!');
	} break;
case 78:
#line	401	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, '~');
	} break;
case 79:
#line	405	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-2].yyv.n, yypt[-0].yyv.n, '=');
	} break;
case 80:
#line	409	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, Z, Z, Z);
		yyval.n=newi(NExpr, yypt[-4].yyv.n, yyval.n, '=');
	} break;
case 81:
#line	414	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, dupnode(etypeof(yypt[-1].yyv.n)), yypt[-1].yyv.n, Z);
		yyval.n=newi(NExpr, yypt[-4].yyv.n, yyval.n, '=');
	} break;
case 82:
#line	419	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-3].yyv.n, yypt[-0].yyv.n, SND);
	} break;
case 83:
#line	423	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NUnit, Z, Z, Z);
		yyval.n=newi(NExpr, yypt[-1].yyv.n, yyval.n, SND);
	} break;
case 85:
#line	429	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, yypt[-1].yyv.n, Z, Z);
	} break;
case 86:
#line	433	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, yypt[-3].yyv.n, yypt[-1].yyv.n, Z);
	} break;
case 87:
#line	437	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NVal, yypt[-0].yyv.n, Z, Z);
	} break;
case 88:
#line	443	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=idnode(yypt[-0].yyv.s);
	} break;
case 89:
#line	447	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NArrayref, yypt[-3].yyv.n, yypt[-1].yyv.n, Z);
	} break;
case 90:
#line	451	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=idnode(yypt[-0].yyv.s);
		yyval.n=new(NStructref, yypt[-2].yyv.n, yyval.n, Z);
	} break;
case 91:
#line	458	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCall, yypt[-2].yyv.n, Z, Z);
	} break;
case 92:
#line	462	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCall, yypt[-3].yyv.n, yypt[-1].yyv.n, Z);
	} break;
case 95:
#line	470	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-1].yyv.n;
	} break;
case 97:
#line	477	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, dupnode(etypeof(yypt[-1].yyv.n)), yypt[-1].yyv.n, Z);
	} break;
case 99:
#line	484	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, dupnode(etypeof(yypt[-1].yyv.n)), yypt[-1].yyv.n, Z);
	} break;
case 100:
#line	488	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NExprlist, yypt[-2].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 101:
#line	492	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, dupnode(etypeof(yypt[-1].yyv.n)), yypt[-1].yyv.n, Z);
		yyval.n=new(NExprlist, yypt[-4].yyv.n, yyval.n, Z);
	} break;
case 102:
#line	499	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NType, yypt[-3].yyv.n, yypt[-1].yyv.n, TProg);
		yyval.n=new(NProg, yyval.n, yypt[-0].yyv.n, Z);
	} break;
case 103:
#line	505	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=dupnode(&unittype);
	} break;
case 104:
#line	509	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-0].yyv.n;
	} break;
case 108:
#line	520	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 109:
#line	524	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-1].yyv.n;
		if(yyval.n->t==NMk)
...
case 110:
#line	530	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NBegin, yypt[-1].yyv.n, Z, Z);
	} break;
case 111:
#line	534	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NBecome, yypt[-1].yyv.n, Z, Z);
	} break;
case 112:
#line	538	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NMk, dupnode(etypeof(yypt[-2].yyv.n)), yypt[-2].yyv.n, Z);
		yyval.n=new(NBecome, yyval.n, Z, Z);
	} break;
case 113:
#line	543	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NResult, yypt[-1].yyv.n, Z, Z);
	} break;
case 114:
#line	547	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NBreak, Z, Z, Z);
	} break;
case 115:
#line	551	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NContinue, Z, Z, Z);
	} break;
case 116:
#line	555	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLoopexpr, Z, yypt[-2].yyv.n, Z);
		yyval.n=newi(NLoop, yypt[-5].yyv.n, yyval.n, 1);
	} break;
case 118:
#line	561	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NIf, yypt[-0].yyv.n, Z, yypt[-2].yyv.n);
	} break;
case 119:
#line	565	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NIf, yypt[-2].yyv.n, yypt[-0].yyv.n, yypt[-4].yyv.n);
	} break;
case 120:
#line	569	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLoopexpr, Z, yypt[-2].yyv.n, Z);
		yyval.n=newi(NLoop, yypt[-0].yyv.n, yyval.n, 0);
	} break;
case 121:
#line	574	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLoopexpr, yypt[-6].yyv.n, yypt[-4].yyv.n, yypt[-2].yyv.n);
		yyval.n=newi(NLoop, yypt[-0].yyv.n, yyval.n, 0);
	} break;
case 122:
#line	579	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NSwitch, yypt[-1].yyv.n, yypt[-4].yyv.n, Z);
	} break;
case 123:
#line	583	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NSelect, yypt[-1].yyv.n, Z, Z);
	} break;
case 124:
#line	589	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 125:
#line	593	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NScope, yypt[-1].yyv.n, Z, Z);
	} break;
case 126:
#line	598	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 128:
#line	605	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCase, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 129:
#line	609	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCase, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
		yyval.n=new(NList, yypt[-2].yyv.n, yyval.n, Z);
	} break;
case 130:
#line	616	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLabel, yypt[-1].yyv.n, Z, Z);
	} break;
case 131:
#line	620	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NDefault, Z, Z, Z);
	} break;
case 132:
#line	624	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLabel, yypt[-1].yyv.n, Z, Z);
		yyval.n=new(NList, yypt[-3].yyv.n, yyval.n, Z);
	} break;
case 133:
#line	631	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCase, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
	} break;
case 134:
#line	635	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NCase, yypt[-1].yyv.n, yypt[-0].yyv.n, Z);
		yyval.n=new(NList, yypt[-2].yyv.n, yyval.n, Z);
	} break;
case 135:
#line	642	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLabel, yypt[-1].yyv.n, Z, Z);
	} break;
case 136:
#line	646	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NLabel, yypt[-1].yyv.n, Z, Z);
		yyval.n=new(NList, yypt[-3].yyv.n, yyval.n, Z);
	} break;
case 137:
#line	653	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, RCV);
	} break;
case 138:
#line	657	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NArraycom, yypt[-3].yyv.n, yypt[-1].yyv.n, Z);
		yyval.n=newi(NExpr, yyval.n, Z, RCV);
	} break;
case 139:
#line	662	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-0].yyv.n, Z, RCV);
		yyval.n=newi(NExpr, yypt[-3].yyv.n, yyval.n, '=');
	} break;
case 140:
#line	667	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NArraycom, yypt[-3].yyv.n, yypt[-1].yyv.n, Z);
		yyval.n=newi(NExpr, yyval.n, Z, RCV);
...
case 141:
#line	673	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=newi(NExpr, yypt[-3].yyv.n, yypt[-0].yyv.n, SND);
	} break;
case 142:
#line	677	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=new(NArraycom, yypt[-6].yyv.n, yypt[-4].yyv.n, Z);
		yyval.n=newi(NExpr, yyval.n, yypt[-0].yyv.n, SND);
	} break;
case 143:
#line	683	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=Z;
	} break;
case 144:
#line	687	"/usr/seh/repos/newsqueak/squint.y"
{
		yyval.n=yypt[-1].yyv.n;
	} break;
	}
